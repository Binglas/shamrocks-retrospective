...
public class ShamRockTinderStackLayout extends FrameLayout {
  ...
  // region Constructors
  public ShamRockTinderStackLayout(Context context) {
    super(context);
    init();
  }

  public ShamRockTinderStackLayout(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }

  public ShamRockTinderStackLayout(Context context, AttributeSet attrs, int defStyle) {
          ...
          public void call(Object event) {
            ...
            if(event instanceof TopCardMovedEvent){
              ...
              for(int i=childCount-2; i>=0; i--){
                ShamRockTinderCardView tinderCardView = (ShamRockTinderCardView) getChildAt(i);
...
//                                        tinderCard.setTranslationY(dy);
  ...
  public void addCard(ShamRockTinderCardView tc){
